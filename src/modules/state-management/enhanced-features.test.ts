...
import { createStateManager, handleSyncError, handleUserEdit, getEditPermissions, SystemState, ErrorType } from '.';
import type { StateManager } from './contracts';
...
describe('Enhanced State Manager Features', () => {
